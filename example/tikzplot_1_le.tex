 ...
 \pgfplotsset{sciclean/.style={axis lines=left,
         ...
         tick align=outside,
         xtick distance=1.6666666666666667,
         ytick distance=1.6666666666666667,
         xticklabel style={
 ...
 \begin{axis}[
     ...
     xmax = 25.000000000000000,
     ymin = 5.0000000000000000,
     ymax = 25.000000000000000,
     legend cell align = left,
     legend pos = south east,
     title = {}]
 
 
 \addplot[name path = 1, thick, solid, color=blue, mark=x] table [x expr=\thisrowno{0}, y expr=\thisrowno{1}]{tikzplot_1_le.dat} node[blue, pos=0.5, above, Sloped]{Example};
