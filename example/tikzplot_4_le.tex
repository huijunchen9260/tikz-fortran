 ...
 \addplot[name path = 1, thick, solid, color=blue, mark=x] table [x expr=\thisrowno{0}, y expr=\thisrowno{1}]{tikzplot_4_le.dat} node[blue, pos=0.5, above, Sloped]{$+1$};
 \addplot[name path = 2, thick, dashdotdotted, color=orange, mark=o] table [x expr=\thisrowno{0}, y expr=\thisrowno{2}]{tikzplot_4_le.dat} node[orange, pos=0.5, above, Sloped]{$+2$};
 \addplot[name path = 3, thick, densely dashdotdotted, color=yellow, mark=star] table [x expr=\thisrowno{0}, y expr=\thisrowno{3}]{tikzplot_4_le.dat} node[yellow, pos=0.5, above, Sloped]{$+3$};
 \addplot[name path = 4, thick, densely dotted, color=purple, mark=square] table [x expr=\thisrowno{0}, y expr=\thisrowno{4}]{tikzplot_4_le.dat} node[purple, pos=0.5, above, Sloped]{$+4$};
