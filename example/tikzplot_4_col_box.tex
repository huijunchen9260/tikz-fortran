 ...
 \addplot[name path = 1, thick, solid, color=gray] table [x expr=\thisrowno{0}, y expr=\thisrowno{1}]{tikzplot_4_col_box.dat};
 \addlegendentry{data1}
 \addplot[name path = 2, thick, dashdotdotted, color=blue] table [x expr=\thisrowno{0}, y expr=\thisrowno{2}]{tikzplot_4_col_box.dat};
 \addlegendentry{data2}
 \addplot[name path = 3, thick, densely dashdotdotted, color=orange] table [x expr=\thisrowno{0}, y expr=\thisrowno{3}]{tikzplot_4_col_box.dat};
 \addlegendentry{data3}
 \addplot[name path = 4, thick, densely dotted, color=yellow] table [x expr=\thisrowno{0}, y expr=\thisrowno{4}]{tikzplot_4_col_box.dat};
